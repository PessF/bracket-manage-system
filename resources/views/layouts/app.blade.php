...
<head>
    ...
    @else
        ...
        <style>{!! file_get_contents(resource_path('css/ui.css')).file_get_contents(resource_path('css/responsive.css')).file_get_contents(resource_path('css/bracket.css')).file_get_contents(resource_path('css/motion.css')) !!}</style>
