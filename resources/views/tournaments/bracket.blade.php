...
<style>
    ...
    @media(max-width:680px){.bracket-viewport{margin-left:-10px;margin-right:-10px;border-radius:0;border-left:0;border-right:0}.bracket-toolbar{align-items:flex-start;flex-direction:column}.bracket-legend{gap:8px 12px}.bracket-legend span:nth-child(-n+2){display:none}.bracket-match-node{width:252px}.bracket-round-title{font-size:11px}.bracket-section{margin-bottom:22px}.bracket-section-head{padding:0 2px}.viewer-event-head{align-items:flex-start}.viewer-event-head h1{font-size:19px}.viewer-event-head .badge{flex:0 0 auto}.match-side{min-width:36px;padding-inline:5px;font-size:9px}.bracket-team-name{gap:5px}.score-modal-team{grid-template-columns:1fr;gap:8px}.score-modal-actions{display:grid;grid-template-columns:1fr 1fr}.score-modal-actions .btn{width:100%}}
</style>
@endpush
