...
return [
    ...
    'quick_start_steps' => ['Create an administrator bearer token from API access.', 'Send the token with every competition API request.', 'Send Accept: application/json and Content-Type: application/json for requests with a body.', 'Add ?lang=en or send Accept-Language: en to receive English messages and validation.'],
    'base_url' => 'Base URL', 'authentication' => 'Authentication and access',
    'authentication_help' => 'Every competition API resource requires an administrator bearer token. Viewers use only the private web link generated by an administrator.',
    ...
    'public_resources' => 'Read-only REST resources', 'public_scope' => 'Administrator bearer token required',
    ...
    'read_endpoints' => [
        ['GET', '/api/health', 'Service health', 'Public'], ['GET', '/api/tournaments', 'Paginated and filterable competition list'], ['GET', '/api/tournaments/{id}', 'Competition with stages, teams, matches, and standings'],
